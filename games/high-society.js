        ...
        function App() {
            ...
            const processAITurn = () => {
                ...
                if (ai.name === 'Oliver') { // Penny Pincher
                    ...
                    if (isNegativeAuction) {
                        maxWillingness = deck.length < 8 ? 20 : 10;
                        negativeDropChance = deck.length < 8 ? 0.1 : 0.5;
                    } else {
